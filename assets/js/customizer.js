...
( function( $ ) {
	...
	wp.customize( 'blogdescription', function( value ) {
		...
		value.bind( function( to ) {
			$( '.peace-fb a' ).attr('href', to );
		} );
	} );
       wp.customize( 'twitter_link_url', function( value ) {
		value.bind( function( to ) {
			$( '.social-links .peace-twitter a' ).attr('href', to );
		} );
	} );
        wp.customize( 'googleplus_link_url', function( value ) {
		value.bind( function( to ) {
			$( '.social-links .peace-gplus a' ).attr('href', to );
		} );
	} );
        wp.customize( 'pinterest_link_url', function( value ) {
		value.bind( function( to ) {
			$( '.social-links .peace-pinterest a' ).attr('href', to );
		} );
	} );
        wp.customize( 'github_link_url', function( value ) {
		value.bind( function( to ) {
			$( '.social-links .peace-github a' ).attr('href', to );
		} );
	} );
        wp.customize( 'youtube_link_url', function( value ) {
		value.bind( function( to ) {
			$( '.social-links .peace-youtube a' ).attr('href', to );
		} );
	} );
		...
		value.bind( function( to ) {
         ...
         wp.customize( 'peace_post_title', function( value ) {
		value.bind( function( to ) {
			$( '.home-post-title h3' ).text( to );
		} );
	} );
         wp.customize( 'peace_post_menu_title', function( value ) {
		value.bind( function( to ) {
		...
		value.bind( function( to ) {
         ...
         wp.customize( 'peace_contact_form', function( value ) {
		value.bind( function( to ) {
		...
		value.bind( function( to ) {
         ...
         wp.customize( 'peace_footer_footer_text', function( value ) {
		value.bind( function( to ) {
