<?php
/**
 * Implement an optional custom header for Peace
 *
 ...
 * @uses peace_header_style() to style front-end.
 * @uses peace_admin_header_style() to style wp-admin form.
 * @uses peace_admin_header_image() to add custom markup to wp-admin form.
 *
 * @since Peace 1.0
 */
function peace_custom_header_setup() {
	$args = array(
		...
		// Support Peaceible height and width.
		'peace-height'            => true,
		'peace-width'             => true,
