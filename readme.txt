...
Peace WordPress Theme, Copyright (C) 2014 IdeaBox Themes
Peace is distributed under the terms of the GNU GPL
...
Widgets are a great way of adding extra content to your site and Peace has a whole assortment of them.
...
Use the following instructions to install & activate Peace using your preferred method.

Manual installation:

1. Unzip the files from the Peace zip file that you downloaded
2. Upload the Peace folder to your /wp-content/themes/ directory
3. Click on the Appearance > Themes menu option in the WordPress Dashboard
4. Click the Activate link below the Peace preview thumbnail
...
Peace is licensed under the [GNU General Public License version 2](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html).
...
Arvo font Copyright Anton Koovit
Arvo font is licensed under SIL Open Font License, 1.1
source: https://www.google.com/fonts/specimen/Arvo
